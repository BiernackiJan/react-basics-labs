...
function App() {
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "Giveaway", description: "Get a giveaway for Esports", deadline: "Next Week"},
      { id: 5, title: "Societies Day", description: "Prepare for societies day" , deadline: "Wednesday"}
    ]
  });
  return (
